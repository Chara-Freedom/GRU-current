...
## Features of GRU
1. Versatility. No separate programs need to be installed to comply with all specifications. The principles of the system can be compatible with a variety of file storage systems (IPNS and Dropbox have been tested). IPNS requires the use of [republisher](https://github.com/Verity-Freedom/GRU-current/blob/main/ipns-republisher.sh), Dropbox — changing its parameter from dl=0 to dl=1; IPNS fundamentally has no internal censorship and is open-source, Dropbox may be easier to use.
