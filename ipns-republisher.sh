...
./ld-linux-x86-64.so.2 --library-path . ../kubo/ipfs routing get /ipns/link2 > record.bin
curl -i -X PUT https://delegated-ipfs.dev/routing/v1/ipns/link2 -H "Content-Type: application/vnd.ipfs.ipns-record" --data-binary @record.bin
sleep 1d
done
